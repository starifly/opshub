  ...
  <div class="limitrange-list">
    ...
    <div class="table-wrapper">
      ...
      >
        <el-table-column label="名称" prop="name" min-width="180" fixed>
          <template #header>
            <span class="header-with-icon">
              <el-icon class="header-icon header-icon-blue"><Operation /></el-icon>
              名称
            </span>
          </template>
          <template #default="{ row }">
            <div class="name-cell">
              <div class="name-icon-wrapper">
                <el-icon class="name-icon" :size="18"><Operation /></el-icon>
              </div>
        ...
        <el-table-column label="Resource" prop="resource" width="120" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.resource || '-' }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Min" prop="min" width="120" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.min || '-' }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Max" prop="max" width="120" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.max || '-' }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Default" prop="defaultLimit" width="120" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.defaultLimit || '-' }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Default Request" prop="defaultRequest" width="140" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.defaultRequest || '-' }}</span>
          </template>
        </el-table-column>

        <el-table-column label="Max Limit Request Ratio" prop="maxLimitRequestRatio" width="180" align="center">
          <template #default="{ row }">
            <span class="resource-value">{{ row.maxLimitRequestRatio || '-' }}</span>
          </template>
        </el-table-column>
...
import { Search, Operation, Document, Delete, Plus } from '@element-plus/icons-vue'
